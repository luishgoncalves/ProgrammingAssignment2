...
# that contains 4 member functions: set, get, setInv and getInv
# it uses <<- assignment operator so that these internal 
# variables are not exposed to the outside environment. 
